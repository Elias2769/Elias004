...
"""   033[0;32m   """   ------------------------------------------------
"""   033[0;32m   """  Owner   :            Elias Hossen
"""   033[0;32m   """  Facebook:            Elias Hossen
"""   033[0;32m   """  Github   :            Elias2769
"""   033[0;32m   """   Version  :            1.0
------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back MEH Menu ")
        exit()

def elias():   
    os.system('clear')
    print(logo) """   033[0;32m   """
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/MEH.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/MEH.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + meh )
    print(47*'-')
    print("File Saved To :" + elias )
    print(47*'-')
    input(f"{S} Press Enter To Back MEH Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/MEH.txt\n') 
        filepath = input("Put File Name: ")
...
def cutter():
    clear()
    print("Enter File Path / File Location \n")
    meh = input('Put File Name:')
    print(" ")
    elias = input('Saving Put File Name:')
    os.system('touch ' +elias)
    os.system('sort -r '+meh+' | uniq > '+elias)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + meh)
    print("New File Saved:" + elias )
    print(47*'-')
    input(f"{S} Press Enter To Back MEH Menu ")
    MEH(allkey)       
